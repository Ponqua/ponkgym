            ...
            <div class="main-content">
                ...
                <div class="form-container">
                    ...
                    <div class="form-content">
                        ...
                        <div class="form-content box signup-box">

                            <div class="logo">

                                <img src="assets/img/Sign-up.png" class="logo-img"/>

                            </div>

                            <form class="login-form" id="login-form" action="process_signup.php" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="login-input">
                                        <input type="password" name="password_confirm" id="confirm-password" placeholder="Repeat Password" required/>
                                    </div>
                                </div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button class="login-btn" id="signup-btn" type="submit" name="signup_btn">Sign up.</button>
